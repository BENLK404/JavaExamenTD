                        ...
                        case 5:
                            ...
                            switch (classementsChoix){
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    String[] infosClassementType = evaluationView.demanderInformationsClassementType();
                                    break;
                                case 3:
                                    String[] infoClassementMatiere = evaluationView.demanderInformationsClassementMatiere();
                                    Evaluation evaluationMatiere = new Evaluation();
                                    break;
                                case 4:
                                    String[] infoClassementClasse = evaluationView.demanderInformationsClassementClasse();
                                    Evaluation evaluationClasse = new Evaluation();
                                    break;
                                case 5:
